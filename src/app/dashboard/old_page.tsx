...
export default function PremiumDashboard() {
  ...
  const allStats = [
    ...
    { label: 'Frequ├¬ncia', value: '82%', icon: TrendingUp, trend: '+2%', roles: ['manager', 'master', 'instructor'] },
      ...
      <div className="px-12 py-12 flex items-center justify-between relative z-10">
        <div>
          <div className="flex items-center gap-3 mb-2">
             ...
             <p className="text-[10px] font-black text-accent-primary uppercase tracking-[0.3em]">Sistema de Elite ÔÇó Online</p>
          </div>
          <h1 className="text-5xl font-display font-black text-text-primary tracking-tighter italic">
            Ol├í, <span className="text-accent-primary">{userName.split(' ')[0]}</span>
          </h1>
          <p className="text-text-muted mt-2 font-bold uppercase tracking-widest text-[10px] opacity-60">
            {userRole === 'instructor' ? 'Monitoramento T├®cnico ÔÇó Vis├úo Restrita' : 'Comando Central ÔÇó Gest├úo de Performance'}
          </p>
        </div>
                    ...
                    <div key={req.id} className="flex items-center justify-between p-5 rounded-[2rem] bg-surface-800 border border-white/5 group hover:border-accent-primary/40 transition-all cursor-pointer">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                           ...
                           <p className="text-[10px] text-text-muted font-bold uppercase tracking-widest">{req.belt} ÔÇó {req.time}</p>
                        </div>
                      </div>
              ...
              <div className="kpi-card !p-12 border-white/5">
                ...
                <div className="space-y-6">
                  <div className="p-6 rounded-[2rem] bg-surface-800 border border-white/5 relative overflow-hidden group hover:bg-surface-800/80 transition-all">
                    ...
                    <p className="text-[10px] text-text-muted font-bold">Inscri├º├Áes abertas ÔÇó 12/04</p>
                  </div>
                  <div className="p-6 rounded-[2rem] bg-surface-800 border border-white/5 relative overflow-hidden group hover:bg-surface-800/80 transition-all">
                    <div className="absolute top-0 right-0 w-24 h-full hatched opacity-5 group-hover:opacity-10 transition-opacity" />
                    <p className="text-xs text-text-primary font-black uppercase tracking-widest mb-1 italic">Semin├írio Mestre Julio</p>
                    <p className="text-[10px] text-text-muted font-bold">Confirmar presen├ºa no App</p>
                  </div>
                </div>
              </div>
            </div>
               ...
               <div className="md:col-span-2 kpi-card !p-12 border-white/5 bg-surface-800/40">
                ...
                <div className="flex items-center justify-between mb-10">
                   <div>
                    ...
                    <p className="text-[10px] text-text-muted font-black mt-1 uppercase tracking-widest">Novos Leads ÔÇó Pipeline</p>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                   {[
                     ...
                     { name: 'Juliana Lima', date: 'Amanh├ú', time: '18:00', img: 'https://i.pravatar.cc/100?u=juli' },
                   ].map((exp, idx) => (
          ...
          <div className="xl:col-span-4 h-fit">
            <div className="kpi-card !p-12 h-full bg-surface-800/60">
               ...
               <div className="flex items-center justify-between mb-12 relative z-10">
                 ...
                 <p className="text-[10px] font-black text-accent-primary uppercase tracking-widest">Mar├ºo 2026</p>
               </div>
               ...
               <div className="space-y-8 relative z-10">
                 <div className="p-8 rounded-[3rem] bg-accent-primary/10 border border-accent-primary/20 relative overflow-hidden group hover:scale-[1.02] transition-all cursor-pointer">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-[10px] font-black text-text-primary uppercase tracking-widest">19:00 ÔÇó Mestre Fraz├úo</span>
                    </div>
                 </div>
                 ...
                 <div className="p-8 rounded-[3rem] bg-surface-700/50 border border-white/5 relative transition-all hover:translate-x-3 cursor-pointer group">
                    ...
                    <h3 className="text-2xl font-display font-black text-text-primary mb-6 leading-tight italic tracking-tighter uppercase">INICIA├ç├âO & <br/>COORDENA├ç├âO</h3>
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-[10px] font-black text-text-muted uppercase tracking-widest">18:00 ÔÇó 1h de treino</span>
                    </div>
                 </div>
               </div>
