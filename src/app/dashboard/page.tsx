            ...
            <div className="kpi-card !p-8 md:!p-10">
              ...
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <p className="text-[10px] text-text-muted font-black uppercase">Inadimplentes · Clique para disparar cobrança</p>
                </div>
                  ...
                  <div key={ov.id} onClick={() => setSelectedOverdue(ov)} className="p-5 rounded-3xl bg-surface-900 border border-red-500/10 hover:border-red-500/40 transition-all cursor-pointer group">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        ...
                        <span className="text-[8px] font-black bg-red-500/10 text-red-400 px-2 py-0.5 rounded-md uppercase">Faixa {ov.student.belt} · {ov.days_overdue} dias</span>
                      </div>
                    </div>
                    <div className="flex items-center justify-between pt-3 border-t border-white/5">
                      <span className="text-[9px] text-text-muted font-bold">R$ {ov.amount}</span>
                      <span className="text-[9px] font-black text-emerald-400 uppercase group-hover:underline">Cobrar via WhatsApp →</span>
                    </div>
                  </div>
                ))}
              </div>
        ...
        {selectedOverdue && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-[10px] font-black text-red-500 uppercase tracking-[0.3em] mb-6">Dossiê do Inadimplente</p>
              ...
              <div className="grid grid-cols-2 gap-6 mb-8 pt-6 border-t border-white/5">
                <div>
                  <p className="text-[10px] font-black text-text-muted uppercase tracking-widest mb-1 opacity-50">Dívida Total</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <button onClick={() => {
                  ...
                  const text = encodeURIComponent(`Fala ${selectedOverdue.student.full_name}! Aqui é da GFTeam 🥋\n\nVi aqui na sua ficha (Faixa ${selectedOverdue.student.belt}) que está com ${selectedOverdue.days_overdue} dias de atraso em ${selectedOverdue.description} (R$ ${selectedOverdue.amount}).\n\nSei que você mencionou: "${selectedOverdue.reason}"\n\nComo posso te ajudar a resolver isso hoje? 🙏`);
